...
Unit: dBm, The signal value smaller, the signal weaker.'''
    description_set_weak_signal_lock_time = '''On device weak signal, lock screen delay time.'''
    description_set_disconnect_lock_time = '''On device disconnect, lock screen delay time.'''
    ...
    menu_set_weak_signal_lock_time = 'Set Device Weak Signal Lock Time'
    menu_set_disconnect_lock_time = 'Set Device Disconnect Lock Time'
